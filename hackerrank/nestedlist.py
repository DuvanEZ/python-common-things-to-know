...
if __name__ == '__main__':
    ...
    # Extracting scores from the list of students
    scores = [student[1] for student in students]

    # Sorting the scores and finding the second lowest grade
    second_lowest_grade = sorted(set(scores))[1]

    # Finding and printing names of students with the second lowest grade
